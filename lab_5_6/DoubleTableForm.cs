...
namespace lab_5_6
{
        public partial class DoubleTableForm : Form
        {
            ...
            public DoubleTableForm(string nameF, string ConnectionString)
            {
                InitializeComponent();
                this.Text = nameF;
                this.Name = nameF;
            ...
            private void DoubleTableForm_Load(object sender, EventArgs e)
            {
